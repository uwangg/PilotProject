...
<a class="btn btn-success" href="${pageContext.request.contextPath}/user?a=logout">로그아웃</a>
<%-- <a class="btn btn-primary" href="${pageContext.request.contextPath}/user?a=modifyform">회원수정</a> --%>
<a class="btn btn-success" href="${pageContext.request.contextPath}/user?a=withdrawalform">회원탈퇴</a>
</div>