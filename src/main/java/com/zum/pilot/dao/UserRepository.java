...
//  User findByUser(@Param("id") Long id, @Param("password") String password); // 로그인
  User findByIdAndPassword(Long id, String password, boolean deleteFlag);
